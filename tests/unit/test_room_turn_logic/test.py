...
class TestRoomTurnLogic(ServiceTestCase):
    ...
    def test_idle_wakeup_logic(self):
        """
        测试点：最大轮次限制后的唤醒机制
        """
        room_name = "test_idle"
    ...
    def test_full_loop_advancement(self):
        """
        测试点：完整轮次计数逻辑
        """
        room_name = "test_loop"
    ...
    def test_all_skip_stops_scheduling(self):
        """
    ...
    def test_all_skip_no_further_turn_events(self):
        """
    ...
    def test_all_skip_wakeup_based_on_state_not_turn_index(self):
        """
    ...
    def test_all_skip_wakeup_by_operator(self):
        """
    ...
    def test_partial_skip_does_not_stop(self):
        """
    ...
    def test_operator_excluded_from_skip_check(self):
        """
    ...
    def test_skip_set_resets_each_round(self):
        """
